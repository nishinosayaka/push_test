...
public class curriculum1_8 {
	...
	public static void main(String[] args) {
		...
		int a = 20;
		int b = 5;
		// boolean型変数 result_1 に条件式「変数 a の値は変数 b の値以上」を代入
		...
		int c = 5;
		int d = 10;
		// boolean型変数 result_2 に条件式「変数 c の値と変数 d の値は等しくない」を代入
		boolean result_2 = c !=d;
		// result_2 をコンソールに出力して下さい。
		...
		int e = 12;
		int f = 8;
		// boolean型変数 result_3 に条件式「変数 e の値は10より大きい かつ 変数 f の値は10未満」を代入
		...
		int g = 7;
		// boolean型変数 result_4 に条件式「変数 g の値は5以下 または 変数 g の値は10以上」を代入
